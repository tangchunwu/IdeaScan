...
class Settings(BaseSettings):
    ...
    crawler_xhs_quick_max_notes: int = 6
    crawler_xhs_quick_max_comments_per_note: int = 10
    crawler_xhs_deep_max_notes: int = 12
    crawler_xhs_deep_max_comments_per_note: int = 20
    crawler_xhs_quick_session_cooldown_s: int = 45
    crawler_xhs_deep_session_cooldown_s: int = 120
